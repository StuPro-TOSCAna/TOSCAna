...
export class CsarsService {
    ...
    /**
     * Get the logEntries of a csar
     * Returns the logEntries for a csar, starting at a specific position. from the given start index all following log lines get returned. If the start index is larger than the current last log index the operation will return a empty list.
     * @param name The unique identifier for the CSAR
