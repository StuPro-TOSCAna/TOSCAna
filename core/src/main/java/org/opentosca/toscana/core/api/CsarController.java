...
public class CsarController {
    ...
    /**
     ...
     404 (application/hal+json): with a standart error message is
    ...
    /**
     ...
     <p>
     <b>HTTP Responce Codes</b>
     <p>
     200 (no Content): Upload succeeded
     400 (application/hal+json, with standart error message): a csar with given name already exists
