...
public interface TransformationService {
    ...
    /**
     * Creates a new transformation instance of given csar for given platform. Does not start the transformation
     * process.
     *
     ...
     * happens asynchronously. That means: method will return before the actual transformation is finished.
     *
     * @return true if transformation got queued or started; false otherwise (e.g., if it was in state
     * <code>INPUT_REQUIRED</code>)
     */
