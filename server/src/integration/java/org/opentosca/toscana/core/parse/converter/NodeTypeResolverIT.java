...
import static org.opentosca.toscana.core.parse.graphconverter.util.NodeTypeResolver.TOSCA_PREFIX;

/**
 Tests whether all natively supported node types of the winery parser are also known to the {@link NodeTypeResolver}.
 */
public class NodeTypeResolverIT extends BaseIntegrationTest {

    private static final Logger logger = LoggerFactory.getLogger(NodeTypeResolverIT.class);
