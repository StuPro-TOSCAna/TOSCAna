...
public class GraphNormalizerTest extends BaseUnitTest {
    ...
    public void repositoryNormalization() {
        ...
        Collection<Entity> repositories = model.getEntity(ToscaStructure.REPOSITORIES).get().getChildren();
    ...
    public void operationNormalization() {
        ...
        Entity createEntity = model.getEntity(createId).get();
        ...
        Entity startEntity = model.getEntity(startId).get();
