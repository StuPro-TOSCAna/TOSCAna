...
# -*- coding: utf-8 -*-
#
# TOSCAna documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'toscana', 'TOSCAna Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TOSCAna', 'TOSCAna Documentation',
     author, 'TOSCAna', 'One line description of project.',
     'Miscellaneous'),
]
